    ...
    function (Base, Span, Lookup, Input) {
        ...
        var ClassificaReadOnly = Base.extend({
            ...
            initialize: function(attrs, options) {
                ...
                this.des_titolario.pinValue =  Base.prototype.getPinValue.call(null, options.PIN.value + ".DES_TITOLARIO" ) ;
                ...
                this.parent_classifica.pinValue =  Base.prototype.getPinValue.call(null, options.PIN.value + ".PARENT_CLASSIFICA") ;
